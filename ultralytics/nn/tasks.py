...
class SPARModel(DetectionModel):
    """YOLOv8 World Model."""
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if (m in base_modules) or (m in extra_base_modules):
            ...
            {Detect, WorldDetect, CLIPDetect, YOLOEDetect, Segment, YOLOESegment, Pose, OBB, ImagePoolingAttn, v10Detect}
        ):
    ...
    if isinstance(model, torch.nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, (Segment, YOLOESegment)):
                ...
                return "obb"
            elif isinstance(m, (Detect, WorldDetect, CLIPDetect, YOLOEDetect, v10Detect)+DETECT_CLASS):
                return "detect"
