...
DETECT_CLASS = (Detect, Detect_LSCD, Detect_RSCD)
...
class BaseModel(torch.nn.Module):
    ...
    def fuse(self, verbose=True, **kwargs):
        ...
        if not self.is_fused():
            ...
            self.info(verbose=verbose,**kwargs)
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolo11n.yaml", ch=3, nc=None, verbose=True, **kwargs):  # model, input channels, number of classes
        """
